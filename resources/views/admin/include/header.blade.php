<header class="progga-navbar">
  ...
  <div class="progga-navbar-actions">
    ...
    <div class="dropdown">
      <img src="{{ Auth::user()->image ?? 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name).'&background=21352a&color=d5aa65&size=68' }}" class="progga-navbar-avatar" alt="User" data-bs-toggle="dropdown" role="button">
